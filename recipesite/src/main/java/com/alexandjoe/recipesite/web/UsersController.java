...
import com.alexandjoe.recipesite.ejb.UsersFacade;
...
public class UsersController implements Serializable {
    ...
    public static class UsersControllerConverter implements Converter<Users> {

        @Override
        public Users getAsObject(FacesContext facesContext, UIComponent component, String value) {
    ...
    // Users does not have an ID column, must be set
        @Override
        public String getAsString(FacesContext facesContext, UIComponent component, Users object) {
            if (object == null) {
                return null;
            }
